...
class CurrencyServiceTest {
    ...
    void convertCurrencyWhenFromAndToAreDifferentShouldBeReturnExchangeDtoWithConvertedAmount() {
        //given
        var exchange = ExchangeDto.builder().fromCurrency("USD").toCurrency("EUR").amount(BigDecimal.valueOf(100)).build();
        var exchangeDtoSimple = new ExchangeRateDto(BigDecimal.valueOf(100), "USD", "EUR", BigDecimal.valueOf(88.880));
        ...
        when(exchangeMapper.exchangeToExchangeDto(any(ExchangeDto.class), any(BigDecimal.class))).thenReturn(exchangeDtoSimple);
    ...
    void convertThisSameCurrencyShouldBeReturnExchangeDtoWithThisSameAmount() {
        //given
        var exchange = ExchangeDto.builder().fromCurrency("PLN").toCurrency("PLN").amount(BigDecimal.valueOf(100)).build();
        var exchangeDtoSimple = new ExchangeRateDto(BigDecimal.valueOf(100), "PLN", "PLN", BigDecimal.valueOf(100));
        List<NBPRateDto> nbpRateList = new ArrayList<>();
        var nbpRateDto = new NBPRateDto("Dolar", "USD", BigDecimal.valueOf(4.0));
        var nbpRateDto1 = new NBPRateDto("Euro", "EUR", BigDecimal.valueOf(4.5));
        nbpRateList.add(nbpRateDto);
    ...
    void convertCurrencyWhenFromIsPLNAndToIsAnotherCurrencyShouldBeReturnExchangeDtoWithConvertedAmount() {
        //given
        var exchange = ExchangeDto.builder().fromCurrency("PLN").toCurrency("EUR").amount(BigDecimal.valueOf(100)).build();
        var exchangeDtoSimple = new ExchangeRateDto(new BigDecimal("100"), "PLN", "EUR", BigDecimal.valueOf(450));
        List<NBPRateDto> nbpRateList = new ArrayList<>();
        var nbpRateDto = new NBPRateDto("Dolar", "USD", BigDecimal.valueOf(4.0));
        var nbpRateDto1 = new NBPRateDto("Euro", "EUR", BigDecimal.valueOf(4.5));
        nbpRateList.add(nbpRateDto);
    ...
    void convertCurrencyWhenToIsPLNAndFromIsAnotherCurrencyShouldBeReturnExchangeDtoWithConvertedAmount() {
        //given
        var exchange = ExchangeDto.builder().fromCurrency("EUR").toCurrency("PLN").amount(BigDecimal.valueOf(100)).build();
        var exchangeDtoSimple = new ExchangeRateDto(BigDecimal.valueOf(100), "EUR", "PLN", BigDecimal.valueOf(22.22));
        List<NBPRateDto> nbpRateList = new ArrayList<>();
        var nbpRateDto = new NBPRateDto("Dolar", "USD", BigDecimal.valueOf(4.0));
        var nbpRateDto1 = new NBPRateDto("Euro", "EUR", BigDecimal.valueOf(4.5));
        nbpRateList.add(nbpRateDto);
